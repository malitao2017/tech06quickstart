 ...
 */
package com.tsingsoft.common.utils.date;
...
public class DateUtil {
	 ...
	 * @return 系统的前一天时间
	 */
	public static final String getPreviousDate(String pattern) {
	 ...
	 * @return 系统的明天时间
	 */
	public static final String getNextDate(String pattern) {
		Calendar cal = GregorianCalendar.getInstance();
		cal.add(Calendar.DAY_OF_MONTH, 1);
		Date date = cal.getTime();
		DateFormat dateFormat = DateBase.getDateFormat(pattern);
	 ...
	 * @return 返回字符型日期
	 */
	public static final String moveDate(String date, int n, String pattern) {
		if (n == 0) {
			return date;
		}
	 ...
	 * @return 返回字符型日期
	 */
	public static final String moveMonth(String date, int n, String pattern) {
		if (n == 0) {
			return date;
		}
		if (date == null || date.trim().equals("")) {
	 ...
	 * @return 日期集合
	 */
	public static final List<String> getDates(String date, int n, String pattern) {
	 ...
	 * @return 日期集合
	 */
	public static final List<String> getDates(String dateO, String dateT, String pattern) {
	 ...
	 * @return 两个日期之间的天数
	 */
	public static final int getDayCountBetween2Days(String dateO, String dateT, String pattern) {
		if ((dateO == null) || (dateT == null) || dateO.trim().equals("")
				|| dateT.trim().equals("")) {
			throw new IllegalArgumentException("传入的日期不能为空！");
		}
	 ...
	 * @return 同类型日
	 */
	public static final String getSimilarDate(String date, int n, String pattern) {
		if (n == 0) {
			return date;
		}
	 ...
	 */
	public static final List<String> getSimilarDates(String dateO, String dateT, String day_of_week,
			String pattern) {
	 ...
	 * @return 目标日期的同类型日列表（pattern格式）
	 */
	public static final List<String> getSimilarDates(String dateO, String dateT, int day_of_week,
			String pattern) {
	 ...
	 */
	public static final List<String> getDates(String dateO, String dateT, String pattern, String type) {
		if ((null == dateO) || (null == dateT) || dateO.trim().equals("")
				|| dateT.trim().equals("")) {
			throw new IllegalArgumentException("传入的日期不能为空！");
		}
	 ...
	 * @return 所有双休日列表
	 */
	public static final List<String> getWeekends(String dateO, String dateT, String pattern) {
	 ...
	 * @return 所有工作日列表
	 */
	public static final List<String> getWorkdays(String dateO, String dateT, String pattern) {
